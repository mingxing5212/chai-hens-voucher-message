 ...
 * 
 */
package me.mingxing5212.chaihens.voucher.message.wechat.common;
...
public class MediaFile {
	...
	public String upload(File file,MediaType type){
		...
		String result = HttpClientUtils.postFile(url, PARAM_FILE, file);
	...
	public byte[] download(String mediaId){
		...
		byte[] fb = HttpClientUtils.getFile(url);
