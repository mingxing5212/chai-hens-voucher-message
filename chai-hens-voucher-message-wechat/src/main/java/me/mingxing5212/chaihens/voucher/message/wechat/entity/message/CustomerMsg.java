...
import me.mingxing5212.chaihens.voucher.message.wechat.entity.event.MsgType;
import me.mingxing5212.chaihens.voucher.message.wechat.entity.token.TokenProxy;
import me.mingxing5212.chaihens.voucher.message.wechat.response.ArticleResponse;
import me.mingxing5212.chaihens.voucher.message.wechat.response.MusicResponse;
import me.mingxing5212.chaihens.voucher.message.wechat.response.VideoResponse;
...
//	}
	...
	private void send(){
		...
		if(StringUtils.isNotBlank(accessToken)){
			...
			HttpClientUtils.post(url, msgBody);
		}
	}
